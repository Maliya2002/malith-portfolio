...
const About = () => {
  ...
  const stats = [
    { num: "06+", label: "Projects", color: "#0066FF" },
    { num: "140+", label: "Commits", color: "#8B5CF6" },
    { num: "10+", label: "Tech Stack", color: "#EC4899" },
    { num: "02", label: "Live Apps", color: "#10B981" },
  ];

  return (
    <section id="about" className="py-40 border-b border-white/[0.04] relative" ref={ref}>
      <div className="max-w-7xl mx-auto px-8">
        ...
        <motion.div {...a(0)} className="flex items-center gap-4 mb-20">
          ...
          <span className="text-white/20 text-xs font-mono tracking-[0.2em] uppercase">About</span>
        </motion.div>

        <div className="grid lg:grid-cols-2 gap-24">
          {/* Left */}
          <div>
            <motion.h2 {...a(0.1)} className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-[-0.03em] mb-10">
              I design &<br />
              build things<br />
              for the <span className="text-blue">web</span>
            </motion.h2>

            <motion.div {...a(0.2)} className="space-y-6 mb-14">
              <p className="text-white/35 text-lg leading-relaxed">
                I'm a passionate <span className="text-white/60">3rd Year IT Undergraduate</span> at SLIIT, Sri Lanka. I love creating digital experiences that are both beautiful and functional.
              </p>
            ...
            <motion.div {...a(0.3)} className="grid grid-cols-4 gap-6">
              {stats.map((s, i) => (
                <div key={i} className="group hover-trigger">
                  ...
                  <div className="text-white/15 text-[10px] font-mono tracking-[0.15em] uppercase">{s.label}</div>
          ...
          {/* Right — Code */}
          <motion.div {...a(0.3)}>
            <div className="bg-white/[0.02] border border-white/[0.04] rounded-2xl p-8 font-mono text-[13px] relative overflow-hidden hover:border-white/[0.08] transition-colors duration-700">
              {/* Corner Glow */}
              <div className="absolute top-0 right-0 w-40 h-40 bg-blue/5 rounded-full blur-[80px]" />

              {/* Header */}
              <div className="flex items-center gap-2 mb-8 pb-4 border-b border-white/[0.04]">
                <div className="flex gap-2">
                  <div className="w-3 h-3 rounded-full bg-[#FF5F57]" />
                  <div className="w-3 h-3 rounded-full bg-[#FFBD2E]" />
                  <div className="w-3 h-3 rounded-full bg-[#28C840]" />
                </div>
                <span className="ml-auto text-white/15 text-[11px]">developer.ts</span>
              </div>
              ...
              <pre className="leading-[2] relative z-10">
                <code>
                  ...
                  <span className="text-white/15">],</span>
                  {"\n  "}
                  <span className="text-white/30">passion</span>
                  <span className="text-white/15">: </span>
                  <span className="text-green">
                    "Clean code &"
                  </span>
              ...
              {/* Bottom Label */}
              <div className="mt-8 pt-4 border-t border-white/[0.04] flex justify-between">
                <span className="text-white/10 text-[10px] font-mono">TypeScript</span>
                <span className="text-white/10 text-[10px] font-mono">UTF-8</span>
              </div>
            </div>
          </motion.div>
        </div>
