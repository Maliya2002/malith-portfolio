    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          <CurrentTime />
          <div className="w-[1px] h-4 bg-white/[0.08] hidden lg:block" />
          {links.map((l) => (
            <MagneticLink key={l} strength={0.15}>
              <Link
                ...
                className="text-slate-400 text-[12px] font-semibold uppercase tracking-[0.15em] cursor-pointer hover:text-white transition-colors duration-300 hover-trigger"
              >
                {l}
              </Link>
            </MagneticLink>
          ...
          <MagneticLink strength={0.2}>
            <a
              ...
              download
              className="bg-blue text-white text-[12px] font-bold px-6 py-2.5 rounded-full hover:bg-white hover:text-black transition-all duration-500 hover-trigger"
            >
              Resume
            </a>
          </MagneticLink>
      ...
      {open && (
        <motion.div
          ...
          className="md:hidden bg-[#0A0A0A] border-t border-white/[0.06] px-8 py-8"
        >
          {links.map((l) => (
            <Link
              key={l}
