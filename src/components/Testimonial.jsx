  ...
  return (
    <section className="py-40 relative overflow-hidden" ref={ref}>
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <span className="font-display text-[25vw] font-bold text-white/[0.015] select-none">"</span>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
        ...
        >
          ...
          <p className="font-display text-2xl md:text-3xl lg:text-4xl font-medium text-slate-200 leading-relaxed mb-10 tracking-tight">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-slate-400 text-sm font-mono tracking-wider">Malith Madushan</span>
            <div className="w-8 h-[1px] bg-white/15" />
          </div>
        </motion.div>
      </div>
