...
const Marquee = () => (
  <div className="py-24 border-y border-white/[0.05] overflow-hidden relative">
    ...
    >
      {[...items, ...items, ...items].map((item, i) => (
        <span key={i} className="font-display text-7xl md:text-9xl font-bold text-white/[0.03] mx-6 select-none hover:text-white/[0.08] transition-colors duration-700">
          {item}
          <span className="text-blue/20 mx-8">✦</span>
        </span>
      ))}
    </motion.div>
  </div>
